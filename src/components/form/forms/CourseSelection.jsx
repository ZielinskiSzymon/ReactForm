const CourseSelection = ({
  ...
  <div className="row g-3">
    <div className="col-md-6">
      ...
      <select
        className={`form-select form-select-lg ${
          errors.wybranaKategoria ? "is-invalid" : ""
        }`}
        id="kategoriaKursu"
      ...
      >
        <option value="">
          {loadingKategorie ? "Ładowanie kategorii..." : "Wybierz kategorię"}
        </option>
        {kategorie.map((kat) => (
      ...
      {errors.wybranaKategoria && (
        <div className="invalid-feedback">{errors.wybranaKategoria}</div>
      )}
    </div>
    ...
    <div className="col-md-6">
      ...
      {errors.kurs_id && (
        <div className="invalid-feedback">{errors.kurs_id}</div>
      )}
    </div>
  </div>
);
